...
### Clean up data for visualization: (1) filter to just the city of Minneapolis, (2) make a column for whether or not the homicide is unsolved, (3) use fct_lump to preserve the three race groups with the highest number of homicides, and fct_relevel to order them by the  finally (4) convert data into an sf object for plotting and set the coordinate reference system (CRS)
```{r}
mpls <- homicides %>%
